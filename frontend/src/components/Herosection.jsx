...
export const Herosection = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[90vh] gap-8 px-4 text-center overflow-hidden bg-slate-900">
      ...
      <div className="flex items-center w-full gap-2 px-3 py-2 mx-auto mt-6 bg-slate-800/80 backdrop-blur-md border border-slate-700 rounded-full shadow-2xl focus-within:ring-2 focus-within:ring-teal-500/50 sm:w-[70%] md:w-[60%] lg:w-[50%] transition-all duration-300 hover:shadow-teal-500/20 animate-fade-in-up z-10" style={{ animationDelay: '0.3s' }}>
      ...
      {/* Stats Section */}
      <div className="flex flex-wrap justify-center gap-8 mt-12 animate-fade-in-up relative z-10" style={{ animationDelay: '0.4s' }}>
        <div className="flex items-center gap-4 px-8 py-4 bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700 shadow-xl shadow-slate-900/50 hover:-translate-y-1 transition-transform">
          ...
          <div className="text-left">
            <h4 className="font-bold text-2xl text-white">10k+</h4>
        ...
        <div className="flex items-center gap-4 px-8 py-4 bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700 shadow-xl shadow-slate-900/50 hover:-translate-y-1 transition-transform">
          ...
          <div className="text-left">
            <h4 className="font-bold text-2xl text-white">50k+</h4>
            <p className="text-sm text-slate-400 font-medium">Talented Pros</p>
          </div>
        </div>
        <div className="flex items-center gap-4 px-8 py-4 bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700 shadow-xl shadow-slate-900/50 hover:-translate-y-1 transition-transform">
          <div className="p-3 bg-amber-500/10 rounded-xl text-amber-400 shadow-inner"><TrendingUp size={28} /></div>
          <div className="text-left">
            <h4 className="font-bold text-2xl text-white">1k+</h4>
